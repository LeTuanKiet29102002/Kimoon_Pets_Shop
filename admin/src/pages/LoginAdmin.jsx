...
const LoginAdmin = () => {
  ...
  console.log("email & mật khẩu nhân viên: ", emailnhanvien, matkhaunhanvien);

  // Gọi hàm đăng nhập - callAPI.js-redux
  const handleClickDangNhap = (e) => {
    e.preventDefault();
    login(dispatch, { emailnhanvien: emailnhanvien, matkhau: matkhaunhanvien });
  };
