...
const Aside = (props) => {
  ...
  // Dashboard
  const [isDashBoardActive, setDashBoardIsActive] = useState(
    props.active === "dashboard" ? true : false
  );
  ...
  // Quản lý Danh mục
  const [isDanhMucActive, setDanhMucIsActive] = useState(
    props.active === "quanlydanhmuc" ? true : false
  );
  ...
  // Quản lý Thú cưng
  const [isThuCungActive, setThuCungIsActive] = useState(
    props.active === "quanlythucung" ? true : false
  );
  ...
  // Quản lý Khách hàng
  const [isKhachHangActive, setKhachHangIsActive] = useState(
    props.active === "quanlykhachhang" ? true : false
  );
  ...
  // Quản lý Nhân viên
  const [isNhanVienActive, setNhanVienIsActive] = useState(
    props.active === "quanlynhanvien" ? true : false
  );
  ...
  // Quản lý Đơn hàng
  const [isDonHangActive, setDonHangIsActive] = useState(
    props.active === "quanlydonhang" ? true : false
  );
    ...
    <Container>
      <Top>
        <Logo>
          ...
          <H2>
            KIMOON PETS{" "}
            <span style={{ color: "var(--color-dark)" }}>- ADMIN</span>
          </H2>
        </Logo>
        <Close>
      ...
      <SideBar>
        <LinkStyled
          to={"/"}
          className={isDashBoardActive ? "active" : null}
        ...
        {admin ? (
          admin.machucvu === 5 ? (
            ...
            <>
              <LinkStyled
                to={"/quanlydanhmuc"}
                className={isDanhMucActive ? "active" : null}
              ...
              <LinkStyled
                to={"/quanlythucung"}
                className={isThuCungActive ? "active" : null}
                onClick={handleClickThuCung}
              >
                <IconSpan>
                  <PetsOutlined
                    style={{ fontSize: "1.6rem", transition: "all 300ms ease" }}
              ...
              <LinkStyled
                to={"/quanlykhachhang"}
                className={isKhachHangActive ? "active" : null}
                onClick={handleClickKhachHang}
              >
                <IconSpan>
                  <PersonOutlineOutlined
                    style={{ fontSize: "1.6rem", transition: "all 300ms ease" }}
              ...
              <LinkStyled
                to={"/quanlynhanvien"}
                className={isNhanVienActive ? "active" : null}
                onClick={handleClickNhanVien}
              >
                <IconSpan>
                  <AssignmentIndOutlined
                    style={{ fontSize: "1.6rem", transition: "all 300ms ease" }}
