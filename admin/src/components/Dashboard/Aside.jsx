...
const Aside = (props) => {
    ...
    return (
        <Container>
            <Top>
                <Logo>
                    <Img src="https://inkythuatso.com/uploads/thumbnails/800/2021/12/logo-dai-hoc-cong-nghiep-ha-noi-inkythuatso-01-21-16-44-16.jpg" />
                    <H2>KIMOON PETS <span style={{ color: "var(--color-dark)" }}>- ADMIN</span></H2>
                </Logo>
                <Close>
