...
const Modal = ({
  ...
  const handleCapNhatNhanVien = async ({
    ...
    if (
        ...
        if (matkhaumoi === rematkhaumoi) {
          try {
            const sdtres = await axios.post(
              "http://localhost:3001/api/user/checkSdtNhanVienUpdate",
              { sdtnhanvien: sdtnhanvienmoi, manhanvien: manhanvien }
            );
            if (sdtres.data.message === "Chưa có sdt nhân viên này!") {
              try {
                // setThuCungModalHinhAnhChange([]);
                if (hinhdaidiennhanvienmoichange !== "") {
                  const updatenhanvienres = await axios.post(
                    "http://localhost:3001/api/user/updateNhanVien",
                    {
                      manhanvien,
                      machucvumoi,
                      maxamoi,
                      ...
                      sdtnhanvienmoi,
                      diachinhanvienmoi,
                      hinhdaidiennhanvienmoi: hinhdaidiennhanvienmoichange,
                    }
                  );
                  ...
                  const dataShow = {
                    message:
                      "Thay đổi nhân viên có mã " + manhanvien + " thành công!",
                    type: "success",
                  };
                  ...
                  const updatenhanvienres = await axios.post(
                    "http://localhost:3001/api/user/updateNhanVien",
                    {
                      ...
                      sdtnhanvienmoi,
                      diachinhanvienmoi,
                      hinhdaidiennhanvienmoi: hinhdaidiennhanvienmoi,
                    }
                  );
                  console.log("KQ trả về update: ", updatenhanvienres);
                  setReRenderData((prev) => !prev); //Render lại csdl ở Compo cha là - ThuCungMain & ThuCungRight.jsx
                ...
                const dataShow = {
                  message:
                    "Thất bại! Không thể cập nhật nhân viên có mã " +
                    manhanvien,
                  type: "danger",
                };
                showToastFromOut(dataShow);
          ...
          const dataShow = {
            message: "Mật khẩu không trùng khớp, hãy kiểm tra",
            type: "danger",
          };
          showToastFromOut(dataShow); //Hiện toast thông báo
        }
        ...
        try {
          ...
          if (sdtres.data.message == "Chưa có sdt nhân viên này!") {
            try {
              ...
              const dataShow = {
                message:
                  "Thất bại! Không thể cập nhật nhân viên có mã " + manhanvien,
                type: "danger",
              };
              showToastFromOut(dataShow);
            }
      ...
      const dataShow = {
        message: "Bạn chưa nhập thông tin cho nhân viên",
        type: "danger",
      };
      showToastFromOut(dataShow); //Hiện toast thông báo
    }
  ...
  const [nhanVienModalEmailNhanVien, setNhanVienModalEmailNhanVien] =
    useState();
  ...
  const [nhanVienModalHoTenNhanVien, setNhanVienModalHoTenNhanVien] =
    useState();
  const [nhanVienModalNgaySinhNhanVien, setNhanVienModalNgaySinhNhanVien] =
    useState();
  const [nhanVienModalGioiTinhNhanVien, setNhanVienModalGioiTinhNhanVien] =
    useState();
  const [nhanVienModalSdtNhanVien, setNhanVienModalSdtNhanVien] = useState();
  const [nhanVienModalDiaChiNhanVien, setNhanVienModalDiaChiNhanVien] =
    useState();
  const [
    nhanVienModalHinhDaiDienNhanVien,
    setNhanVienModalHinhDaiDienNhanVien,
  ] = useState([]);
  const [
    nhanVienModalHinhDaiDienNhanVienChange,
    setNhanVienModalHinhDaiDienNhanVienChange,
  ] = useState("");
  ...
  const [nhanVienModalMaNhanVienOld, setNhanVienModalMaNhanVienOld] =
    useState();
  const [nhanVienModalMaChucVuOld, setNhanVienModalMaChucVuOld] = useState();
  const [nhanVienModalEmailNhanVienOld, setNhanVienModalEmailNhanVienOld] =
    useState();
  const [nhanVienModalMatKhauOld, setNhanVienModalMatKhauOld] = useState();
  const [nhanVienModalHoTenNhanVienOld, setNhanVienModalHoTenNhanVienOld] =
    useState();
  const [
    nhanVienModalNgaySinhNhanVienOld,
    setNhanVienModalNgaySinhNhanVienOld,
  ] = useState();
  const [
    nhanVienModalGioiTinhNhanVienOld,
    setNhanVienModalGioiTinhNhanVienOld,
  ] = useState();
  const [nhanVienModalSdtNhanVienOld, setNhanVienModalSdtNhanVienOld] =
    useState();
  const [nhanVienModalDiaChiNhanVienOld, setNhanVienModalDiaChiNhanVienOld] =
    useState();
  const [
    nhanVienModalHinhDaiDienNhanVienOld,
    setNhanVienModalHinhDaiDienNhanVienOld,
  ] = useState("");
  const [nhanVienModalTenXaOld, setNhanVienModalTenXaOld] = useState();
  const [nhanVienModalTenQuanHuyenOld, setNhanVienModalTenQuanHuyenOld] =
    useState();
  const [nhanVienModalTenThanhPhoOld, setNhanVienModalTenThanhPhoOld] =
    useState();
  const [nhanVienModalMaXaOld, setNhanVienModalMaXaOld] = useState();
  const [nhanVienModalMaQuanHuyenOld, setNhanVienModalMaQuanHuyenOld] =
    useState();
  const [nhanVienModalMaThanhPhoOld, setNhanVienModalMaThanhPhoOld] =
    useState();
  useEffect(() => {
    // setThuCungModalHinhAnh([]);
    // setThuCungModalHinhAnhChange([]);
    ...
    const getNhanVien = async () => {
      try {
        const nhanvienres = await axios.post(
          "http://localhost:3001/api/user/findNhanVienById",
        ...
        setNhanVienModalHinhDaiDienNhanVien(
          nhanvienres.data[0].hinhdaidiennhanvien
        );
        ...
        setNhanVienModalNgaySinhNhanVienOld(
          nhanvienres.data[0].ngaysinhnhanvien
        );
        setNhanVienModalGioiTinhNhanVienOld(
          nhanvienres.data[0].gioitinhnhanvien
        );
  ...
  useEffect(() => {
    const getQuanHuyenUpdate = async () => {
      const quanhuyenres = await axios.post(
        ...
        { mathanhpho: nhanVienModalMaThanhPho }
      );
  ...
  useEffect(() => {
    const getXaPhuongThiTranUpdate = async () => {
      const xaphuongthitranres = await axios.post(
        ...
        { maquanhuyen: nhanVienModalMaQuanHuyen }
      );
      ...
      if (matkhaumoi === rematkhaumoi) {
        try {
          const emailres = await axios.post(
            "http://localhost:3001/api/user/checkEmailNhanVien",
          ...
          if (emailres.data.message == "Chưa có email nhân viên này!") {
            try {
              const sdtres = await axios.post(
                "http://localhost:3001/api/user/checkSdtNhanVien",
                { sdtnhanvien: sdtnhanvienmoi }
              );
              if (sdtres.data.message == "Chưa có sdt nhân viên này!") {
                try {
                  const insertnhanvienres = axios.post(
                    "http://localhost:3001/api/user/insertNhanVien",
                    {
                  ...
                  const dataShow = {
                    message:
                      "Thêm nhân viên " + hotennhanvienmoi + " thành công!",
                    type: "success",
                  };
                  showToastFromOut(dataShow);
                  ...
                  setShowModal((prev) => !prev);
                  const dataShow = {
                    message: "Đã có lỗi khi thêm nhân viên " + hotennhanvienmoi,
                    type: "danger",
                  };
                  showToastFromOut(dataShow); //Hiện toast thông báo
                }
  ...
  useEffect(() => {
    const getChucVu = async () => {
      try {
        const chucvures = await axios.post(
          "http://localhost:3001/api/user/getChucVu",
          {}
        );
  ...
  const handleXoaNhanVien = async ({ manhanvien }) => {
    if (manhanvien !== "") {
      try {
        const deletenhanvienres = await axios.post(
          "http://localhost:3001/api/user/deleteNhanVien",
          { manhanvien }
        );
        ...
        const dataShow = {
          message: "Đã xóa nhân viên mã " + manhanvien + " thành công!",
          type: "success",
        };
        showToastFromOut(dataShow);
      } catch (err) {
                ...
                <div style={{ display: "flex", marginTop: "15px" }}>
                  ...
                  <div style={{ display: "flex", flex: "1" }}>
                    ...
                    <ModalFormItem style={{ flex: "1" }}>
                      ...
                      <FormInput
                        type="text"
                        value={nhanvien.ngaysinhnhanvien.substring(0, 10)}
                        readOnly
                      />
                    </ModalFormItem>
                    <ModalFormItem style={{ flex: "1" }}>
                      ...
                      <FormInput
                        type="text"
                        value={nhanvien.gioitinhnhanvien}
                        readOnly
                      />
                    </ModalFormItem>
                  </div>
                  ...
                  <ModalFormItem style={{ flex: "1", marginLeft: "265px" }}>
                    ...
                    <FormInput
                      ...
                      value={
                        ...
                        nhanvien.tenxa +
                        ", " +
                        nhanvien.tenquanhuyen +
                        ", " +
                        nhanvien.tenthanhpho
                      }
                      readOnly
                    />
                  </ModalFormItem>
              ...
              <ModalForm>
                <div style={{ display: "flex", marginTop: "15px" }}>
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormInput
                      type="text"
                      onChange={(e) => setHoTenNhanVienMoi(e.target.value)}
                  ...
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormSelect
                      onChange={(e) => {
                        setMaChucVuMoi(e.target.value);
                      }}
                    >
                      {chucVu.map((chucvu, key) => {
                        return (
                          <FormOption value={chucvu.machucvu}>
                            {" "}
                            {chucvu.tenchucvu}{" "}
                          </FormOption>
                        );
                  ...
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormSelect
                      onChange={(e) => {
                        setGioiTinhNhanVienMoi(e.target.value);
                      }}
                    >
                  ...
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormInput
                      type="date"
                      onChange={(e) => setNgaySinhNhanVienMoi(e.target.value)}
                    />
                  </ModalFormItem>
                </div>
                ...
                <div style={{ display: "flex" }}>
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormInput
                      type="text"
                      onChange={(e) => setDiaChiNhanVienMoi(e.target.value)}
                  ...
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormInput
                      type="text"
                      onChange={(e) => setSdtNhanVienMoi(e.target.value)}
                ...
                <div style={{ display: "flex" }}>
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormInput
                      type="email"
                      onChange={(e) => setEmailNhanVienMoi(e.target.value)}
                  ...
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormInput
                      type="text"
                      onChange={(e) => setReMatKhauMoi(e.target.value)}
                ...
                <div style={{ display: "flex", marginTop: "15px" }}>
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormInput
                      type="text"
                      onChange={(e) =>
                        setNhanVienModalHoTenNhanVien(e.target.value)
                      }
                      value={nhanVienModalHoTenNhanVien}
                    />
                  </ModalFormItem>
                  <ModalFormItem style={{ flex: "1" }}>
                    <FormSpan>Chức vụ:</FormSpan>
                    <FormSelect
                      onChange={(e) => {
                        setNhanVienModalMaChucVu(e.target.value);
                      }}
                    >
                      {chucVu.map((chucvu, key) => {
                        if (chucvu.machucvu === nhanVienModalMaChucVu) {
                          return (
                            <FormOption value={chucvu.machucvu} selected>
                              {" "}
                              {chucvu.tenchucvu}{" "}
                            </FormOption>
                          );
                  ...
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormSelect
                      onChange={(e) => {
                        setNhanVienModalGioiTinhNhanVien(e.target.value);
                      }}
                    >
                  ...
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormInput
                      type="date"
                      onChange={(e) =>
                        setNhanVienModalNgaySinhNhanVien(e.target.value)
                      }
                      value={nhanVienModalNgaySinhNhanVien}
                    />
                  </ModalFormItem>
                </div>
                <div style={{ display: "flex" }}>
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormSelect
                      onChange={(e) => {
                        setNhanVienModalMaThanhPho(e.target.value);
                      }}
                    >
                      <FormOption value="">-- Chọn thành phố --</FormOption>
                      {mangTinhThanhPhoUpdate.map((tinhthanhpho, key) => {
                        if (
                          tinhthanhpho.tenthanhpho === nhanVienModalTenThanhPho
                        ) {
                          return (
                            <FormOption
                  ...
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormSelect
                      onChange={(e) => {
                        setNhanVienModalMaQuanHuyen(e.target.value);
                      }}
                    >
                      {mangQuanHuyenUpdate.length > 0 ? (
                        mangQuanHuyenUpdate.map((quanhuyen, key) => {
                          if (
                            quanhuyen.tenquanhuyen === nhanVienModalTenQuanHuyen
                          ) {
                            return (
                              <FormOption
                  ...
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormSelect
                      onChange={(e) => {
                        setNhanVienModalMaXa(e.target.value);
                      }}
                    >
                ...
                <div style={{ display: "flex" }}>
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormInput
                      type="text"
                      onChange={(e) =>
                        setNhanVienModalDiaChiNhanVien(e.target.value)
                      }
                      value={nhanVienModalDiaChiNhanVien}
                    />
                  </ModalFormItem>
                  <ModalFormItem style={{ flex: "1" }}>
                    <FormSpan>Số điện thoại:</FormSpan>
                    <FormInput
                      type="text"
                      onChange={(e) =>
                        setNhanVienModalSdtNhanVien(e.target.value)
                      }
                      value={nhanVienModalSdtNhanVien}
                    />
                  </ModalFormItem>
                </div>
                <div style={{ display: "flex" }}>
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormInput
                      type="email"
                      value={nhanVienModalEmailNhanVien}
                      disabled
                    />
                  </ModalFormItem>
                  <ModalFormItem style={{ flex: "1" }}>
                    ...
                    <FormInput
                      type="text"
                      onChange={(e) => {
                        setNhanVienModalMatKhau(e.target.value);
                      }}
                      value={nhanVienModalMatKhau}
                    />
                  </ModalFormItem>
                  {nhanVienModalMatKhau !== nhanVienModalMatKhauOld ? (
                    <ModalFormItem style={{ flex: "1" }}>
                      ...
                      <FormInput
                        type="text"
                        onChange={(e) => {
                          setNhanVienModalReMatKhau(e.target.value);
                        }}
                ...
                <ModalFormItem>
                  ...
                  <ImageWrapper>
                    {nhanVienModalHinhDaiDienNhanVienChange != "" ? ( //Khi mảng hình có hình thì hiện các hình trong mảng
                      <ChiTietHinhAnh
                        src={nhanVienModalHinhDaiDienNhanVienChange}
                      />
                    ) : (
                      //Khi mảng hình trống thì hiện No Available Image
          ...
          <Background ref={modalRef} onClick={closeModal}>
            ...
            >
              <ModalContent>
                ...
                <p>
                  Thông tin nhân viên không thể khôi phục. Bạn có chắc chắn?
                </p>
                <Button>
                  <ButtonContainer>
                    <ButtonClick
                      onClick={() => {
                        handleXoaNhanVien({ manhanvien: nhanvien.manhanvien });
                      }}
                    >
                      Đồng ý
                    </ButtonClick>
