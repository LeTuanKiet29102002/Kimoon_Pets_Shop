    ...
    const getNhanVien = async () => {
      try {
        const nhanvienres = await axios.post(
          "http://localhost:3001/api/user/getNhanVien",
          {}
        );
    ...
    const timNhanVien = async () => {
      try {
        const ketquares = await axios.post(
          "http://localhost:3001/api/user/findNhanVien",
          { hotennhanvien: timkiem }
        );
      ...
      return (
        <Tr>
          ...
          <Td className="info">
            <ButtonInfo
              onClick={() =>
                openModal({ type: "chitietnhanvien", nhanvien: nhanvienitem })
              }
            >
              <RemoveRedEyeOutlined />
            </ButtonInfo>
          ...
          <Td className="warning">
            <ButtonFix
              onClick={() =>
                openModal({ type: "chinhsuanhanvien", nhanvien: nhanvienitem })
              }
            >
              <DriveFileRenameOutlineOutlined />
            </ButtonFix>
          ...
          <Td className="primary">
            <ButtonDelete
              onClick={() =>
                openModal({ type: "xoanhanvien", nhanvien: nhanvienitem })
              }
            >
              <DeleteSweepOutlined />
            </ButtonDelete>
                  ...
                  <Tr>
                    ...
                    <Td className="info">
                      <ButtonInfo
                        onClick={() =>
                          openModal({
                            type: "chitietnhanvien",
                            nhanvien: nhanvienitem,
                          })
                        }
                      >
                        <RemoveRedEyeOutlined />
