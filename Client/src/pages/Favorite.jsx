                ...
                <>
                  <Product>
                    <ProductDetail>
                      ...
                      <Details>
                        <ProductName>
                          <b style={{ marginRight: "10px" }}>Tiêu đề:</b>
                          {product.data[0].tieude}
                        </ProductName>
                        <ProductId>
                          <b style={{ marginRight: "5px" }}>Phân loại:</b>{" "}
                          {product.data[0].tendanhmuc}
                        </ProductId>
                        <ProductId>
                          <b style={{ marginRight: "5px" }}>Tên thú cưng:</b>{" "}
                          {product.data[0].tenthucung}
                        </ProductId>
                        <ProductId>
                    ...
                    <PriceDetail>
                      <ProductAmountContainer>
                        <div
                          onClick={() =>
                            product.soluongmua < product.data[0].soluong &&
                            handleRemove(1)
                          }
                        >
                          <Add />
                      ...
                      <ProductPrice>
                        {format_money(
                          (
                            product.soluongmua * product.data[0].giamgia
                          ).toString()
                        )}{" "}
                        <b>
                          <u>đ</u>
