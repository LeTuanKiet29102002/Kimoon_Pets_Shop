    ...
    return (
        <Container>
            <Left>
                ...
                <Desc>
                    Kimoon Pets tâm niệm rằng thú cưng chính là những người bạn đáng quý với con người. Vì vậy, chúng tôi luôn mong muốn đem lại cho thú cưng những dịch vụ, tiện ích tốt nhất kết hợp cùng với công nghệ hiện đại để mang tới những trải nghiệm tốt nhất dành cho khách hàng.
                </Desc>
                <SocialContainer>
            ...
            <Right>
                ...
                <ContactItem>
                    ...
                    Số 1 đường Trần Hữu Dực, Phường Mỹ Đình 2, Quận Nam Từ Liêm, Thành phố Hà Nội, Việt Nam
                </ContactItem>
                <ContactItem>
